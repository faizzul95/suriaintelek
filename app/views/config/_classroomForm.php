<form id="formLevel" action="classroom/create" method="POST">

    <div class="row">
        <div class="col-lg-12">
            <div class="form-group">
                <label> Class Name <span class="text-danger">*</span> </label>
                <input type="text" id="class_name" name="class_name" class="form-control" maxlength="50" autocomplete="off" required>
            </div>
        </div>
    </div>
    ...
    <div class="row mt-2">
        <div class="col-lg-6">
            <div class="form-group">
                ...
                <input type="number" id="class_max_student" name="class_max_student" class="form-control" placeholder="Min : 1, Max : 150" min="1" max="150" autocomplete="off" required>
            </div>
        </div>
        <div class="col-lg-6">
            <div class="form-group">
                <label> Status <span class="text-danger">*</span> </label>
                <select id="class_status" name="class_status" class="form-control" required>
    ...
    <div class="row mt-4">
        <div class="col-lg-12">
            ...
            <center>
                <input type="hidden" id="class_id" name="class_id" class="form-control" readonly>
