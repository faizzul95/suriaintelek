...
<h4 class="py-3 breadcrumb-wrapper mb-4">
    <span class="text-muted fw-light"> Application /</span> Reject Application
</h4>
...
<script type="text/javascript">
    ...
    async function getDataList() {
        countApplication();
        generateDatatable('dataList', 'serverside', 'admission/getListRejectDt', 'nodatadiv');
    }
    ...
    async function approveApplication(id) {
        cuteAlert({
            type: 'question',
            title: 'Are you sure?',
            message: 'The application will be APPROVED!',
            closeStyle: 'circle',
            cancelText: 'Abort',
            ...
            async (e) => {
                if (e == 'confirm') {
                    const res = await deleteApi(id, 'admission/delete', getDataList);
                }
            }
        );
    }
    ...
    function rejectApplication(id) {
        cuteAlert({
            type: 'question',
            title: 'Are you sure?',
            message: 'The application will be REJECTED!',
            closeStyle: 'circle',
            cancelText: 'Abort',
            confirmText: 'Yes, Confirm!',
        }).then(
