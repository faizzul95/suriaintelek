...
<script type="text/javascript">
    ...
    async function doAssessmentReport(id) {
        const res = await callApi('post', "reportcard/getReportIDByFilter", {
            'report_id': id,
            'level_id': $('#levelStudent').val(),
            'report_date': $('#date_filter').val(),
        });
        loadFileContent('reportcard/_assessmentForm.php', 'generalContent', 'fullscreen', 'Assessment Form', res.data);
    }
</script>
