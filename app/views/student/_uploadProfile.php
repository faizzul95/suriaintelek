...
<div class="row">
    <form id="changeProfilePicture" method="POST" action="student/uploadProfile">
        <div class="col-12">
            ...
            <center>
                ...
                <label>
                    ...
                    <input type="hidden" name="stud_id" id="stud_id" placeholder="stud_id">
        ...
        $("#changeProfilePicture").submit(function(event) {
            ...
            croppie.result('base64').then(async function(base64) {
                ...
                if (isSuccess(res.status)) {
                    var newAvatar = res.data.data['stud_image'];
                    $("#student_avatar_view").attr("src", baseurl + '/' + newAvatar);
