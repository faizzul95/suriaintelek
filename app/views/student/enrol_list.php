...
<h4 class="py-3 breadcrumb-wrapper mb-4">
    <span class="text-muted fw-light"> Student /</span> Enrollment
</h4>
...
<script type="text/javascript">
    ...
    async function getDataList() {
        ...
        generateDatatable('dataList', 'serverside', 'student/getListEnrolDt', 'nodatadiv', {
            'academicID': academic
        });
    }
    ...
    function formModal(type = 'create', data = null) {
        ...
        loadFormContent('student/_studentForm.php', 'generalContent', 'lg', urlForm, modalTitle, data);
