...
function noStudentSelect($filesName = 'search-folder.png')
{
    echo "<div id='nodata' class='col-lg-12 mb-4 mt-2'>
          <center>
...
function noSelectDataLeft($type = 'Classroom', $filesName = '5.png')
{
...
function noReportCard($roleID, $filesName = '5.png')
{
    $buttonCreate = ($roleID == 1 || $roleID == 2) ? "<button class='btn btn-info btn-md' onclick='createReportCard()'>
                        <i class='fa fa-plus'></i> Create Report Card
                    </button>" : '';
    echo "
        <div id='nodata' class='col-lg-12 mb-2 mt-4' style='margin-top:50px!important;'>
          <center>
            <img src='" . url('public/framework/img/nodata/' . $filesName) . "' class='img-fluid mb-5' width='45%'>
            <h3 style='letter-spacing :2px; font-family: Quicksand, sans-serif !important;margin-bottom:15px'> 
...
function noSyllabus($filesName = 'search-folder.png')
{
    echo "<div id='nodata' class='col-lg-12 mb-4 mt-2'>
            <center>
                <img src='" . url('public/framework/img/nodata/' . $filesName) . "' class='img-fluid' width='38%'>
                <h3 style='letter-spacing :2px; font-family: Quicksand, sans-serif !important;margin-bottom:15px'> 
            ...
            <div class='row d-flex justify-content-center w-100'>
                <div class='col-lg m-1 text-left' style='max-width: 350px !important;letter-spacing :1px; font-family: Quicksand, sans-serif !important;font-size: 12px;'>
                    1. Try register syllabus for this subject first.<br>
                    2. Click on reload button below.<br>
                    3. Contact your administrator for support.<br>
                </div>
            </div>
            <center>
                <a href='javascript:void(0)' id='reloadFormBtn' class='btn btn-warning btn-md mt-4' onclick='reloadAssessmentForm()'>
